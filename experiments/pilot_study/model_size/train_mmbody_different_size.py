#!/usr/bin/env python3
"""
Train MMBody dataset with different model sizes using Ray for distributed training.

Usage:
    python train_mmbody_different_size.py
"""
...
# Project paths
# File is at: experiments/pilot_study/model_size/train_mmbody_different_size.py
# Need 4 levels up to reach project root
PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "src/pose_estimation/configs/mmbody.yaml"
TRAIN_SCRIPT = PROJECT_ROOT / "src/pose_estimation/train/train_hpe.py"

# Model sizes to train
# SIZE_LIST = ["nano", "micro", "tiny", "small", "base", "large", "xl"]
SIZE_LIST = ["large", "xl"]
...
def train_single_job(job_id: int, size: str, base_cfg: dict, train_script: str):
    ...
    job_name = f"mmbody_{size}_job{job_id:02d}"
