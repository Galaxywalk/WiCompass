#!/usr/bin/env python3
"""
Train MMBody dataset with different data ratios using Ray for distributed training.
...
Usage:
    python train_mmbody_efficiency.py
"""
...
# Project paths
# File is at: experiments/pilot_study/data_efficiency/train_mmbody_efficiency.py
...
@ray.remote(num_gpus=0.5, max_retries=2)
def train_single_job(job_id: int, ratio: float, base_cfg: dict, train_script: str):
    ...
    job_name = f"mmbody_ratio{ratio:.2f}_job{job_id:02d}"
